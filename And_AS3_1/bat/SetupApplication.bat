...
:: Android packaging
set AND_CERT_NAME="And_AS3_1"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\AndAS31.p12
...
set IOS_PROVISION=cert\AndAS31.mobileprovision
...
set APP_ID=air.AndAS31

:: Output packages
set DIST_PATH=dist
set DIST_NAME=AndAS31
