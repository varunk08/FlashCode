...
:: Android packaging
set AND_CERT_NAME="AndroidLander"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\AndroidLander.p12
...
set IOS_PROVISION=cert\AndroidLander.mobileprovision
...
set APP_ID=air.AndroidLander

:: Output packages
set DIST_PATH=dist
set DIST_NAME=AndroidLander
