...
:: Android packaging
set AND_CERT_NAME="And_Flex_Exp1"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\AndFlexExp1.p12
...
set IOS_PROVISION=cert\AndFlexExp1.mobileprovision
...
set APP_ID=air.AndFlexExp1

:: Output packages
set DIST_PATH=dist
set DIST_NAME=AndFlexExp1
