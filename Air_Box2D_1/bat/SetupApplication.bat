...
:: Android packaging
set AND_CERT_NAME="Air_Box2D_1"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\AirBox2D1.p12
...
set IOS_PROVISION=cert\AirBox2D1.mobileprovision
...
set APP_ID=air.AirBox2D1

:: Output packages
set DIST_PATH=dist
set DIST_NAME=AirBox2D1
