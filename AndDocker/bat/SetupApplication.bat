...
:: Android packaging
set AND_CERT_NAME="AndDocker"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\AndDocker.p12
...
set IOS_PROVISION=cert\AndDocker.mobileprovision
...
set APP_ID=air.AndDocker

:: Output packages
set DIST_PATH=dist
set DIST_NAME=AndDocker
