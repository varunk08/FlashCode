...
:: Android packaging
set AND_CERT_NAME="Android_Flex1"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\AndroidFlex1.p12
...
set IOS_PROVISION=cert\AndroidFlex1.mobileprovision
...
set APP_ID=air.AndroidFlex1

:: Output packages
set DIST_PATH=dist
set DIST_NAME=AndroidFlex1
